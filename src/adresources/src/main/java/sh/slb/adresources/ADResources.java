...
public class ADResources {
    ...
    public ADResources() {
        ...
        registerBasicBlock("ore 1");
		registerBasicBlock("ore 2");
		registerBasicBlock("ore 3");
		registerBasicBlock("ore 4");
		registerBasicBlock("ore 5");
		registerBasicBlock("ore 6");
		registerBasicBlock("ore 7");
		registerBasicBlock("ore 8");
		registerBasicBlock("ore 9");


		//
		//for (int i = 0; i <= 9; i++) {
        //    registerBasicBlock("ore" + i);
        //}
        ...
        RegistryObject<Block> block = BLOCKS.register(name, 
            () -> new SemaphoreBlock(
                BlockBehaviour.Properties.of()
                    ...
                    .strength(50F, 36000F), //why not at this point
                level
            )
        );
        ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties()));
